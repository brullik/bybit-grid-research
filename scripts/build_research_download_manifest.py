...
def main() -> None:
    ...
    parser.add_argument("--universe", default="data/processed/research_eligible_universe.parquet")
    parser.add_argument("--feasible", default="data/processed/research_eligible_universe.parquet")
    ...
    manifest.write_parquet("data/processed/research_download_manifest.parquet")
    write_download_plan(
        Path("reports/sprint_02_research_download_plan.md"), manifest, args.days, args.max_gb
    )
