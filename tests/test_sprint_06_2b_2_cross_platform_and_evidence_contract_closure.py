...
def test_run_status_lifecycle_and_no_review_pack_ok(tmp_path):
    ...
    failed = read_json(out_root / "ohlc_minimal_v2_synthetic" / "ohlc_replay_run_status.json")
    ...
    status = read_json(out_root / "ohlc_minimal_v2_synthetic" / "ohlc_replay_run_status.json")
