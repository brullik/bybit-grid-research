...
Документация #132 публикуется lifecycle #144/#145/#146; после её merge порядок такой:

1. Repository-history gate #133 до credentials.
2. Assurance #134 по текущему main без исполнения старых веток.
3. Исправление pre-freeze #129.
4. Ограниченные задачи umbrella #131 до deterministic offline E2E.
5. Owner-provided public history только после synthetic E2E.
6. Live design — отдельный будущий проект после выполнения Definition of Done.
